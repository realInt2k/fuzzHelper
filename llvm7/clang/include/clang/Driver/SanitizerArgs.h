...
class SanitizerArgs {
 ...
 public:
  ...
  bool needsHandler8Rt() const { 
    return Sanitizers.has(SanitizerKind::Handler8); 
  }
  bool needsHandler8HelperRt() const {
    return Sanitizers.has(SanitizerKind::Handler8Helper);
  }
