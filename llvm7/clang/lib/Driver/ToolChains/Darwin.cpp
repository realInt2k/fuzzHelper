...
void DarwinClang::AddLinkRuntimeLibArgs(const ArgList &Args,
  ...
  if (Sanitize.needsHandler8Rt())
      AddLinkSanitizerLibArgs(Args, CmdArgs, "handler8");
  if (Sanitize.needsHandler8HelperRt())
      AddLinkSanitizerLibArgs(Args, CmdArgs, "handler8Helper");
