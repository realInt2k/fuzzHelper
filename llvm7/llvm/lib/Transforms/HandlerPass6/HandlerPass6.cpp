...
namespace
{
  ...
  struct HandlerPass6 : public ModulePass
  {
  public:
    static char ID;
    HandlerPass6() : ModulePass(ID) {};
...
char HandlerPass6::ID =1;
static RegisterPass<HandlerPass6> X("HandlerPass6", "handling with global variable and link external IR functionsand support function blocking via the goddamn argument input :D");

static llvm::RegisterStandardPasses Y(
  llvm::PassManagerBuilder::EP_EarlyAsPossible,
  [](const llvm::PassManagerBuilder &Builder,
    llvm::legacy::PassManagerBase &PM){ PM.add(new HandlerPass6()); });
